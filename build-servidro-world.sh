...
PLUGIN_DIR="$PROJECT_ROOT/custom-plugins/servidro-world"
CLASSES_DIR="$PLUGIN_DIR/build/classes"
JAR_FILE="$PLUGIN_DIR/build/ServidroWorld.jar"
SERVER_JAR="$PROJECT_ROOT/server/plugins/ServidroWorld.jar"
...
rm -f "$PROJECT_ROOT/server/plugins/.paper-remapped/ServidroWorld.jar"

echo "ServidroWorld compilado e instalado en $SERVER_JAR"
